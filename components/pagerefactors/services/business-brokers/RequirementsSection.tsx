  ...
  const stateRequirements = [
    {
      ...
      authorityLink: "https://www.nsw.gov.au/housing-and-construction/property-professionals/supervising-an-agency/real-estate-trust-accounts-and-audit-requirements",
      deadline: "Submit by 30 September",
      ...
      notes: "Annual audit required. Must lodge notification form with ADI. Nil returns required if no trust money held.",
      keyRequirements: [
        ...
        "Report lodged via NSW Fair Trading Auditor's Report Online",
