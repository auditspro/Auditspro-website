...
// Flow nodes data for real estate agent audits
const flowNodesData: Record<string, FlowNodeData> = {
  start: {
    title: "Real Estate Inquiry",
    subtitle: "Initial Contact",
    description: "Submit your real estate agency audit requirements",
    icon: UserIcon,
    iconBg: "bg-brand-100",
    ...
    details:
      "Contact us with your real estate agency details and trust account audit requirements. We'll provide initial consultation and scope assessment. Average response time: 24 hours.",
  },
  review: {
    title: "Trust Account Review",
    subtitle: "Expert Analysis",
    description: "Qualified auditors examine your real estate records",
    ...
    details:
      "Our qualified auditors with real estate expertise thoroughly review your trust account records, client fund management, and compliance procedures.",
  },
  compliance: {
  ...
  report: {
    title: "Real Estate Audit Report",
    subtitle: "Final Delivery",
    description: "Regulatory compliant audit report with findings",
    ...
    details:
      "You receive a comprehensive regulatory compliant audit report with detailed findings, recommendations, and compliance certification. Reports are submission-ready for regulatory authorities.",
  },
  complete: {
    title: "Fully Compliant",
    subtitle: "Certification",
    description: "Your real estate audit is complete and compliant",
    ...
    details:
      "Congratulations! Your real estate trust account audit is complete and fully regulatory compliant. You'll receive your certification and can proceed with confidence.",
  },
};
  ...
  return (
    <section className="py-16 lg:py-24 bg-gradient-to-br from-slate-50 via-white to-brand-50/30 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="mb-6 flex justify-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-brand-200/70 bg-white/70 backdrop-blur px-4 py-2 text-sm font-medium text-brand-950 supports-[backdrop-filter]:bg-white/40">
              ...
              <span>Interactive Real Estate Process</span>
            </div>
          </div>
          ...
          <p className="mb-4 text-base lg:text-lg text-slate-600 leading-relaxed">
            From initial inquiry to regulatory compliance certification in{" "}
            ...
            - click any step for details. We also provide specialized services for{" "}
            <Link
          ...
          <div className="mb-12">
            ...
            >
              View detailed real estate audit guide
        ...
        >
          <div className="rounded-xl lg:rounded-2xl bg-gradient-to-br from-slate-50 to-white border border-slate-200/80 p-6 sm:p-8 shadow-sm hover:shadow-md transition-all duration-300">
            <div className="flex items-start gap-4 mb-6">
              <div className="flex-shrink-0 p-3 bg-brand-100 rounded-xl">
        ...
        >
          <div className="rounded-xl lg:rounded-2xl bg-gradient-to-r from-brand-50 to-brand-100/50 border border-brand-200/50 p-6 sm:p-8">
            <h3 className="mb-4 text-xl sm:text-2xl font-bold text-brand-950">
              Ready to Start Your Real Estate Audit?
            </h3>
            <p className="mb-6 text-sm sm:text-base text-slate-600 max-w-2xl mx-auto leading-relaxed">
              Join hundreds of Australian real estate professionals who trust us with their
