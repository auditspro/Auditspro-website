...
const contactOptions = [
  {
    icon: PhoneIcon,
    title: "Call Us",
    description: "Speak directly with our legal audit experts",
    action: "1300 AUDITS",
    href: "tel:1300283487",
  ...
  },
  {
    icon: EnvelopeIcon,
    title: "Email Support",
    description: "Get detailed answers about legal audits",
  ...
  },
  {
    ...
    title: "Live Chat",
    description: "Chat with our legal audit specialists",
    action: "Coming Soon",
    href: "#",
  ...
  },
  {
    ...
    description: "Schedule a free legal audit consultation",
    action: "Book Now",
    href: "/contact",
...
const keyBenefits = [
  ...
  },
  {
    ...
    text: "Law Society compliant reports",
    desc: "All audits meet professional regulatory standards",
  },
  {
    icon: CheckCircleIcon,
    text: "IPA qualified legal auditors",
    desc: "Specialized auditors with legal practice expertise",
  },
  {
    icon: CurrencyDollarIcon,
    text: "Fixed pricing from $1,949 + GST",
    ...
    <section className="container relative mx-auto px-4 sm:px-6 py-16">
      ...
      >
        ...
        <p className="text-base sm:text-lg text-slate-600 max-w-2xl mx-auto">
          Ready to ensure compliance with Law Society requirements? Our expert legal auditors 
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="bg-white/80 backdrop-blur border border-brand-200/50 rounded-2xl p-8 supports-[backdrop-filter]:bg-white/60 shadow-lg">
            <ContactForm
              title="Start Your Legal Practice Audit"
              subtitle="Get your Law Society compliant audit started with our legal practice specialists."
              variant="solicitor"
              theme="light"
              showTitle={true}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <h3 className="text-xl font-semibold text-brand-950 mb-6">
              Contact Our Legal Audit Experts
            </h3>
          ...
          >
            <h4 className="text-xl font-semibold text-brand-950 mb-6">
              Why Choose Our Legal Audit Services
            </h4>
            <div className="space-y-4">
