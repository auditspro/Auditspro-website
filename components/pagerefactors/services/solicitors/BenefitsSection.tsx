...
// Enhanced key benefits data for solicitors with accurate information
const keyBenefits = [
  {
    icon: ShieldCheckIcon,
    title: "Fully Compliant",
    shortDesc: "All reports meet state regulatory requirements across Australia",
    fullDesc: "All audit reports meet state regulatory authority requirements and legal practice standards across all Australian states. Comprehensive compliance review ensuring adherence to Law Society regulations and state-specific professional requirements.",
    highlights: [
  ...
  },
  {
    ...
    fullDesc: "24-hour response time with audit completion in 5-10 business days. Priority processing available for urgent legal practice requirements with dedicated project management and direct auditor access.",
    highlights: [
      "24-hour initial response guarantee",
      "5-10 day standard completion",
      "Priority processing for urgent needs",
      "Dedicated legal practice auditors",
    ],
  ...
  },
  {
    ...
    shortDesc: "Fixed pricing from $1,949 + GST per trust account",
    fullDesc: "Transparent pricing from $1,949 + GST per trust account with no hidden costs or surprises. Additional control accounts are $100 + GST each. All-inclusive pricing covers audit examination, report preparation, and ongoing legal compliance support.",
    highlights: [
      "Starting from $1,949 + GST per trust account",
  ...
  {
    icon: TrophyIcon,
    title: "Expert Legal Auditors",
    shortDesc: "IPA qualified auditors specializing in legal practices",
    fullDesc: "IPA qualified auditors with specialized experience in legal practice trust accounts. Deep understanding of Law Society requirements, Legal Profession Uniform Law, and legal profession compliance standards across all Australian jurisdictions.",
    highlights: [
      "IPA qualified professionals",
      "Legal practice specialists",
      "Multi-state Law Society expertise",
  ...
  },
  {
    ...
    fullDesc: "Detailed audit reports with clear findings and actionable recommendations. Law Society submission-ready format with professional auditor's opinion, compliance assessment, and improvement suggestions for enhanced trust account management.",
    highlights: [
      "Law Society submission-ready format",
  ...
  },
  {
    ...
    fullDesc: "Dedicated support team available throughout the audit process with direct access to your assigned auditor. Ongoing consultation and guidance included for trust account management, compliance questions, and regulatory updates affecting legal practices.",
    highlights: [
  ...
  return (
    ...
    >
      <section className="py-16 lg:py-24">
          ...
          >
            ...
            <div className="mb-6 flex justify-center">
              <div className="inline-flex items-center gap-2 rounded-full border border-brand-200/70 bg-white/70 backdrop-blur px-4 py-2 text-sm font-medium text-brand-950 supports-[backdrop-filter]:bg-white/40">
                ...
                <span>Legal Practice Advantages</span>
              </div>
            </div>
            ...
            <h2 className="mb-4 text-3xl lg:text-4xl font-bold text-brand-950 leading-tight">
              ...
              <span className="text-brand-600">Your Legal Practice Audits?</span>
            </h2>
            <p className="mb-12 text-base lg:text-lg text-slate-600 leading-relaxed">
              Experience the difference with our professional audit services designed specifically for solicitors and legal practices. 
              We combine legal expertise, technology, and transparent processes 
        ...
        {/* Additional Value Proposition for Legal Practices */}
        <Motion
          initial="hidden"
          whileInView="visible"
          viewport={motionViewport}
        ...
        >
          <div className="rounded-2xl bg-gradient-to-r from-brand-50 to-brand-100/50 border border-brand-200/50 p-8">
            <h3 className="mb-4 text-2xl font-bold text-brand-950">
              Trusted by Legal Practices Across Australia
            </h3>
            <p className="mb-6 text-slate-600 max-w-2xl mx-auto">
              Join hundreds of solicitors and legal practices across Australia who trust us with their compliance requirements. 
              Our comprehensive approach ensures full Law Society compliance while saving you time and providing peace of mind.
            </p>
