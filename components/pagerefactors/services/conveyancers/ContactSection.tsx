...
const contactOptions = [
  {
    icon: PhoneIcon,
    title: "Call Us",
    description: "Speak directly with our conveyancing audit experts",
    action: "1300 AUDITS",
    href: "tel:1300283487",
  ...
  },
  {
    icon: EnvelopeIcon,
    title: "Email Support",
    description: "Get detailed answers about conveyancing audits",
  ...
  },
  {
    ...
    title: "Live Chat",
    description: "Chat with our conveyancing audit specialists",
    action: "Coming Soon",
    href: "#",
  ...
  },
  {
    ...
    description: "Schedule a free conveyancing audit consultation",
    action: "Book Now",
    href: "/contact",
...
const keyBenefits = [
  ...
  },
  {
    ...
    text: "IPA qualified conveyancing auditors",
    desc: "Specialized auditors with conveyancing expertise",
  },
  {
    icon: CurrencyDollarIcon,
    text: "Fixed pricing from $549 + GST",
    desc: "Transparent state-based pricing with no hidden costs",
  },
];
    ...
    <section className="container relative mx-auto px-4 sm:px-6 py-16">
      ...
      >
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-medium tracking-tight text-brand-950 mb-4">
          Get Your Conveyancing Audit Started
        </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <h3 className="text-xl font-semibold text-brand-950 mb-6">
              Contact Our Conveyancing Audit Experts
            </h3>
          ...
          >
            <h4 className="text-xl font-semibold text-brand-950 mb-6">
              Why Choose Our Conveyancing Audit Services
            </h4>
            <div className="space-y-4">
      ...
      >
        <div className="bg-gradient-to-br from-brand-50 to-white border border-brand-200/50 rounded-2xl p-8 shadow-lg">
          ...
          {/* Cross-page interlinking for SEO */}
          <div className="mt-8 pt-6 border-t border-brand-200/50">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <Link 
                ...
                className="inline-flex items-center gap-1 text-sm text-brand-700 hover:text-brand-900 font-medium transition-colors"
              >
                Solicitors Trust Account Audits
