          ...
          >
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <ArrowRight className="w-4 h-4 text-gray-400 group-hover:text-blue-600 group-hover:translate-x-1 transition-all duration-200 flex-shrink-0 ml-2 mt-1" />
              </div>
            </Link>
          </Motion>
        ))}
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {relatedLinks.slice(0, 3).map((link, index) => (
          ...
          >
            <Link
              href={link.href}
              className="group block p-6 border border-gray-200 rounded-xl hover:border-blue-300 hover:shadow-lg transition-all duration-200"
            >
